//
//  Private1ViewController.swift
//  TurkInvests
//
//  Created by Metin Donmez on 21.04.2019.
...
class Private1ViewController: UIViewController ,UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func privatedata()  {
        ...
        query.whereKey("number", contains: "11")
