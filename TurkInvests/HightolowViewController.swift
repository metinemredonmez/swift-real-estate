...
class HightolowViewController: UIViewController ,UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func  lowdata()  {
        ...
        query.order(byDescending: "pricevalue")
