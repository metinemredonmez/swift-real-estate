//
//  Our RecommendViewController.swift
//  TurkInvests
//
//  Created by Metin Donmez on 22.04.2019.
...
class OurRecommendViewController: UIViewController ,UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func  numberdata()  {
        ...
        query.order(byDescending: "number")  // number a göre çekildiği için number yazıldı !!!
        query.limit = 20;
